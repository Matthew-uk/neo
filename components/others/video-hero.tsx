...
export default function VideoHeroWithModal({
      ...
      <div className="w-full flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 mt-0 md:mt-8">
        ...
        >
          ...
          <div className="w-full relative bg-gray-900 h-[420px] md:h-[520px] lg:h-[640px]">
            ...
            <div className="absolute inset-0 flex items-end justify-center pb-12 md:pb-14 lg:pb-20 pointer-events-none">
              <div className="pointer-events-auto">
                <button
                  ref={ctaRef}
                  onClick={() => setOpen(true)}
                  className="inline-flex items-center gap-3 px-6 py-3 bg-white/45 text-white font-medium text-base rounded-full shadow-[0_10px_30px_rgba(2,6,23,0.35)] hover:scale-[1.02] active:scale-[0.99] transition-transform focus:outline-none focus-visible:ring-4 focus-visible:ring-white/60 focus-visible:ring-offset-4"
            ...
            <div className="absolute left-4 bottom-4 text-white/80 text-xs sm:text-sm pointer-events-none">
              {/* Decorative; kept commented intentionally */}
              {/* <div className="rounded-md bg-black/35 backdrop-blur-sm px-3 py-1">Preview • Muted • Looping</div> */}
            </div>
          </div>
        </div>
      </div>
